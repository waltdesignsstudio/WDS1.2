...
import { Menu, X, ArrowUpRight, Phone, Sparkles, LogIn, LogOut, User as UserIcon, LayoutDashboard } from 'lucide-react';
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 bg-[#29072e] border-b border-fuchsia-900/40 shadow-md ${
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            ...
            {/* ZONE 3: Primary Actions (Login / Auth State + Contact CTA) */}
