...
const SUCCESS_STORIES: Testimonial[] = [
  {
    ...
    quote:
      'Being a college student in Indore, I was scared of fake online jobs asking for registration fees. Walt Designs is 100% genuine with zero investment. They provided ready-to-send pitch scripts and lead catalogs. I closed 14 branding clients last month and received ₹16,800 directly in my bank account via UPI!',
  ...
  },
  {
    ...
    quote:
      'The company-supported expected data and WhatsApp pitch playbooks make client conversations effortless. Reaching local doctors, gym owners, and retail shops needing websites is straightforward. Closing 4 clients a week helped me earn ₹20,400 last month with total freedom.',
  ...
  },
  {
    ...
    tenure: '5 months with Walt',
    earnings: '₹18,000',
    numericEarnings: 18000,
    clientsClosed: 15,
    category: 'top_earner',
    categoryLabel: 'Work-from-Home Homemaker',
    rating: 5,
    image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=300&h=300&q=80',
    quote:
      'Managing a household and earning independently seemed impossible until I joined Walt as a freelance sales manager. I coordinate with local coaching institutes and clinics on WhatsApp. Receiving ₹18,000 monthly straight to my SBI account has given me financial independence.',
    verifiedPayout: 'Verified Bank Sync: ₹18,000',
  },
  {
    id: '8',
    name: 'Harpreet Singh',
    ...
    state: 'Punjab',
    role: 'Freelance Sales Manager',
    tenure: '2 months with Walt',
    earnings: '₹10,800',
    numericEarnings: 10800,
    clientsClosed: 9,
    category: 'student',
    categoryLabel: 'Graduate Student',
    rating: 5,
    image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=300&h=300&q=80',
    quote:
      'Legitimate work with zero deposit is rare in India. Walt provides full marketing portfolios, client contracts, and immediate proof of delivery. Closing 9 graphic packaging deals earned me ₹10,800 with zero stress.',
    verifiedPayout: 'Verified UPI Transfer: ₹10,800',
  },
];
